...
# ==============================================================================
# [LIB] UTILITIES & CORE FUNCTIONS (Digabung Langsung)
# ==============================================================================
...
# ==============================================================================
# [2] INISIALISASI MODUL LAIN (Tema, Bahasa, Logo, GUI)
# ==============================================================================
init_system_modules() {
    mkdir -p "$THEME_DIR" "$LANG_DIR" "$LOGOS_DIR" "$GUI_DIR"
...
# ==============================================================================
# [6] INSTALLATION BOOTSTRAPPER (AUTO-REFRESH & AUTO-TRANSITION)
# ==============================================================================
termux-wake-lock
animate_logo
ensure_storage_setup
...
# --- NX_CODE ENVIRONMENT ---
[ -f "$HOME/nx_code.sh" ] && source "$HOME/nx_code.sh" --ui-only
