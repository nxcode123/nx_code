...
# Inisialisasi file log baru#!/data/data/com.termux/files/usr/bin/bash
...
echo -e "\n${NEON_GREEN}[✔] NXC - TERMUX-UBUNTU (v1.1.7) DEPLOYMENT BERHASIL!${NC}"
echo -e "${NEON_YELLOW} [1] Auto-update dengan pesan 'up-to-date' dan opsi [y/N] aktif.${NC}"
